% DrGPE_HQ_Train_NS_UVP2Y
% A HQ terminal for dimension reduction GPE _Special design for Navier
% stock equation for the special format of dataset( e.g. merger U,V,P to Y
...
%Structure 3
Dim_X=1; % only a temporary value as reminder. Would be detect later by the script. Used for to help define GP structure
