Matlab Toolbox for Dimensionality Reduction (v0.6b)
===================================================
...
Features
-------------------------
This Matlab toolbox implements 32 techniques for dimensionality reduction. These techniques are all available through the COMPUTE_MAPPING function. The following techniques are available:
