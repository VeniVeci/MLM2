function [Y,T,Time_Ode_solver]=Burger1D_FEM_DBC_MOR_SolverF(Paras,U,UF,P)
...
tic;
% [T,Z] = ode45(@(t,z) Burgers1D_DBC_FEM_ODE_MOR_DEIM_func(t,z,Mr,Br,Cr,Fr,v,U,UF,P),t,Z_int); % Solve ODE
[T,Z] = ode15s(@(t,z) Burgers1D_DBC_FEM_ODE_MOR_DEIM_func(t,z,Mr,Br,Cr,Fr,v,U,UF,P),t,Z_int,options); % Solve ODE
% [T,Z] = ode45(@(t,z) Burgers1D_DBC_FEM_ODE_MOR_DEIM_func(t,z,Mr,Br,Cr,Fr,v,U,UF,P),t,Z_int,options); % Solve ODE
