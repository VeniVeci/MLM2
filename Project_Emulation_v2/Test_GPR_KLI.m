%Test_GPR_KLI
%Test Gaussian process kernel pca & linear pca & Isomap
...
num_train=180;                  %Defining the input parameters
num_test=100;
...
%        options = struct('ker','sigmoid','arg',[0.000001,0],'new_dim',new_dim);
        ...
        [Y_star_svd,Yvar_star_svd,t_svd]=GPR_SVD(X,Y,X_star,new_dim);       %Kpca GPR
