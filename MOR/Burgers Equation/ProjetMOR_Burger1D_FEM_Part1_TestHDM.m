...
Paras.t_n=500;        % Number of time step 

Paras.n_snap=Paras.t_n;      % ture number =Paras.n_snap+1. %WARMING:Paras.t_n/Paras.n_snap must =integer.
...
%     save('ExpDataV2_25.mat','X','Y_Rec','Time','Paras','rang');
