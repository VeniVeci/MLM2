%Burger1D_FEM_DBC_MOR_DEIM_SolverF_Demo
...
approximate_degree=2;
approximate_degree_DEIM=2;
...
% POD on non-linear terms.
[U_DEIM,S_DEIM,~]=svd(Y1_inter); 
[~,U_DEIM,P] = DEIM(U_DEIM);

[Y3,T3,Time_Ode_MORsolver2]=Burger1D_FEM_DBC_MOR_DEIM_SolverF(Paras,U,U_DEIM(:,1:approximate_degree_DEIM),P(:,1:approximate_degree_DEIM));
...
figure(3)
meshc(Y2)
title(sprintf('DEIM MOR FEM Solution. Time cost= %0.3f',Time_Ode_MORsolver))
