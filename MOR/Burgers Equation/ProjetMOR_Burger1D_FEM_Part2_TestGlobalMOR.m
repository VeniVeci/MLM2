...
% load('ExpDataV2_21.mat') 
% load('ExpDataV2_24.mat') 
load('ExpDataV2_9.mat') %7 is ok for HH, HH fails in 4.

Num_Trian=180;   % 80 is best for 'ExpData3,4.mat'
Index_test=402; % 400,403 is tracky. mostly fine. in ExpData4 404 best
...
[U_orig,S,~]=svd(Y_orig_snaps(2:end-1,:),'econ');  % U*S*V'=Rec_X
% [U_orig,S,~]=svd(T_orig);
