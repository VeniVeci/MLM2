...
k=10;                % Thermal conductivity is 1000W/m/K     % A sensitive parameter effects the stablility of solution(highter rho require more nodes for a grid)
rho=1;               % flow density       % A sensitive parameter effects the stablility of solution(highter rho require more nodes for a grid)
T_L=0;                % Temperature of Left    boundary 
T_R=0;                % Temperature of Right   boundary 
T_B=0;                % Temperature of Bottom  boundary 
T_T=0;                % Temperature of Top     boundary 
u_x=20;               % Velocity x direction 
u_y=-20;              % Velocity y direction 

T_0=0;              % initial temperature
...
Index_frame=1;
    ...
    for i = 1:Num_node_x
        for j = 1:Num_node_y
            ...
            S_u=-S_PW*T_L-S_PE*T_R-S_PS*T_B-S_PN*T_T(i);
