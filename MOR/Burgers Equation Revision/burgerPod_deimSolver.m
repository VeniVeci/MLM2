function [Y,T,timeCost]=burgerPod_deimSolver(Paras,gx,u0,U,U_DEIM,P)
...
tic;
[T,Z] = ode45(@(t,z) pod_deimOde(t,z,Mr,Br,Cr,Fr,v,U,Dr,P),t,Z_int); % Solve ODE
...
function [dz]=pod_deimOde(t,z,Mr,Br,Cr,Fr,v,U,Dr,P)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     dz = Mr\ (Fr-(1/2)*Br* (Dr*P'*((U*z).^2)) -v*Cr*z);
