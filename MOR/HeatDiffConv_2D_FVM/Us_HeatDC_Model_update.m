function [Rec_X,Time]=Us_HeatDC_Model_update(Paras)
...
Index_frame=1;
    ...
    for i = 1:Num_node_x
        for j = 1:Num_node_y
            ...
            u_wx=(P(1,Node_P_index)-dx/2-z1)/((P(1,Node_P_index)-dx/2-z1)^2+(P(2,Node_P_index)-z2)^2);
            u_ex=(P(1,Node_P_index)+dx/2-z1)/((P(1,Node_P_index)+dx/2-z1)^2+(P(2,Node_P_index)-z2)^2);
            u_sy=(P(2,Node_P_index)-dy/2-z2)/((P(2,Node_P_index)-dy/2-z2)^2+(P(1,Node_P_index)-z1)^2);
            u_ny=(P(2,Node_P_index)+dy/2-z2)/((P(2,Node_P_index)+dy/2-z2)^2+(P(1,Node_P_index)-z1)^2);
