...
t_end=0.2;             % total simulation time 
dt=0.01;                  % time step
...
Int_Paras.Lx=Lx;
Int_Paras.Ly=Ly;
Int_Paras.Num_node_x=Num_node_x;
Int_Paras.Num_node_y=Num_node_y;
Options=[];
[T,X,Y] = GausFieldF(Int_Paras);
X_0=T(:);
...
%             u_ny=alph*(P(2,Node_P_index)+dy/2-z2)/((P(2,Node_P_index)+dy/2-z2)^2+(P(1,Node_P_index)-z1)^2);
            ...
            %Scheme1 
            [u_wx,u_wy] = uxy(P(1,Node_P_index)-dx/2,P(2,Node_P_index),Paras);
            [u_ex,u_ey] = uxy(P(1,Node_P_index)+dx/2,P(2,Node_P_index),Paras);
            [u_sx,u_sy] = uxy(P(1,Node_P_index),P(2,Node_P_index)-dy/2,Paras);
            [u_nx,u_ny] = uxy(P(1,Node_P_index),P(2,Node_P_index)+dy/2,Paras);
