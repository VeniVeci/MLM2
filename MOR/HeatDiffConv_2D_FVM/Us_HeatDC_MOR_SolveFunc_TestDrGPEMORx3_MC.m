%% Us_HeatDC_MOR_SolveFunc_TestDrGPEMORx3_MC
%
% Modifications:
% 5-4-2016, WeiX, first edition 
% 9-9-2016, WeiX, add error sort
...
%     RE_U_OrigSnapS(i,:)=sum((Y_U_OrigSnapS_Rec(:,:,i)-Y_Rec(:,:,Test_StartIndex+i-1)).^2,1);   %Square sum error; integral on dx
